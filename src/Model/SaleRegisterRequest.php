...
class SaleRegisterRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['payment_method']) > 255)) {
    ...
    public function setCustomerEmail($customer_email)
    {
        ...
        if (!is_null($customer_email) && (mb_strlen($customer_email) > 255)) {
            throw new \InvalidArgumentException('invalid length for $customer_email when calling SaleRegisterRequest., must be smaller than or equal to 255.');
        }
    ...
    public function setPaymentMethod($payment_method)
    {
        ...
        if ((mb_strlen($payment_method) > 255)) {
            throw new \InvalidArgumentException('invalid length for $payment_method when calling SaleRegisterRequest., must be smaller than or equal to 255.');
        }
