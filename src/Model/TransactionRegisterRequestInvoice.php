...
class TransactionRegisterRequestInvoice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'contact_id' => 'int',
        'contact' => '\Book2000\ApiClient\Model\TransactionRegisterRequestInvoiceContact',
        'type' => 'string',
     ...
     * Sets contact_id
     *
     * @param int|null $contact_id The invoice contact: either an existing contact (contact_id) or a new contact to create (contact).
     *
     * @return self
     */
     ...
     * Gets contact
     *
     * @return \Book2000\ApiClient\Model\TransactionRegisterRequestInvoiceContact|null
     */
     ...
     * Sets contact
     *
     * @param \Book2000\ApiClient\Model\TransactionRegisterRequestInvoiceContact|null $contact contact
     *
     * @return self
     */
