...
class Configuration
{
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/1.5.2/PHP';
    ...
    {
        $report  = 'PHP SDK (Book2000\ApiClient) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 1.5.2' . PHP_EOL;
        $report .= '    SDK Package Version: 1.5.2' . PHP_EOL;
